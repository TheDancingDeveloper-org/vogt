"""Migrations are forward-only, locked, and honest about it."""
...
def test_shipped_migration_ids_are_an_append_only_prefix(
    ...
    """An applied migration identity may never move or disappear.
...
def test_a_pre_session_instance_migrates_forward_with_its_data(
    ...
    Built the same way as the foundation case below: a copy of the shipped
    directory
