"""The write-plane demo, as an executable acceptance test.
...
def test_m1_demo(instance: AppContext, agent: Agent) -> None:
    ...
    # create a bug — project-less, because `work.create` on an unlinked
    # project is the typed link-or-publish refusal, and what this demo
    # drives is the write plane, not the forge.
    bug = agent.tool(
        "work_create",
        kind="bug",
