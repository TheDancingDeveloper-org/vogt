"""Readiness gates on migration, and `migrate` is a verb.

The failure these exist to stop is specific and was open for a long time. The
...
def test_migrate_is_reachable_as_a_cli_verb() -> None:
    """The lifecycle verbs name `migrate`. The gap was never the capability."""
...
def test_readiness_is_red_when_a_store_is_behind_this_build(
    ...
    """The whole of the readiness gate, one store at a time.
