"""The derived git story on a work item — branch / PR / phase + drift.

With branches observed and the PR edge observed, a work item can
...
def test_work_get_carries_the_git_block_with_phase_pr_and_freshness(
    ...
    # The agent task's conclusion is a seam, not folded in.
