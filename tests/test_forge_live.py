...
def test_manifest_branches_follow_the_283_naming_pattern() -> None:
    """Each fixture branch names the forge number of the item it binds."""
    manifest = _manifest()
...
def _live_provider_and_ref() -> tuple[GitHubProvider, RepoRef]:
    ...
    # docs/CONTRIBUTING.md). Until it exists — or if GitHub is unreachable —
