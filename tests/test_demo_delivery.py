...
def test_demo_image_branches_from_the_normal_web_build() -> None:
    ...
    # npm's transitive deps forced the removal below, and then
    ...
    # — its transitive deps are what the fatal Trivy gate flags. The slim
...
def test_demo_publication_is_main_only_scanned_signed_and_never_deploys() -> None:
    ...
    assert "Pin this signed digest" in job
