...
### Revision r21 — the merged image is cached, and its toolchain is built once
...
### Revision r22 — a write goes upstream as the person who made it
