/**
 * The first-run setup steps: forge link and first
 ...
 * `forge.account_link`, the picker is `forge.repos`, and the
 ...
 *
 * Every write collects a reason the user typed; nothing here
      ...
      <div class="vogt-setup-body">
        ...
        <article class="vogt-setup-panel" aria-label="Forge step">
          ...
          <p>
            ...
            upstream writes are attributed to you. It is validated
