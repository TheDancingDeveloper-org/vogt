// The progressive filter grammar Board and Backlog both speak.
//
...
interface FiltersProps {
   ...
   * `+ Filter` disclosure at every width: naming and recalling a lens
  ...
  return (
    <div
      class={`vogt-filters ${props.prefix}-toolbar${
        // With nothing applied there is nothing to summarise, so the
...
export interface Lens {
  ...
  title: string;
  /**
   * The one lens applied automatically on a bare load. At most one is
...
interface LensProps {
   ...
   * Optional so a surface without persisted defaults still renders a
  ...
  note: JSX.Element;
  /**
   * A surface-supplied affordance to undo the last Forget. Forget is
...
/** Naming the current combination, and recalling a named one. */
