...
const Inbox: Component<Props> = (props) => {
  ...
  // Free-text over the loaded entries, alongside the source pills. A
  ...
  // The stamp only moves on an answer we believe, and the Inbox
   ...
   *  never wipes the answer on a failed background read. This is the
  ...
  // What the list draws, after the free-text box. Kept separate from
  ...
  // because the server filtered them. "Clear all" archives exactly these.
  ...
  // Clear every active entry currently in the inbox. It goes through the
  ...
  return (
    <section class="vogt-surface inbox inbox-surface" aria-label="Inbox">
      ...
      {/* Clear every active entry in view. Its own always-available
