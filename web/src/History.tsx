 ...
 * session, live and dead: archived rows read from the history store are
...
const History: Component<Props> = (props) => {
  ...
  // The output search is debounced: these track whether the pending
  ...
  // The output search runs server-wide, so it is debounced: a keystroke
