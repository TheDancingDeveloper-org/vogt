...
describe("canonical Inbox interactions", () => {
  ...
  // A live nudge must not wipe a composer or a loaded second page.
  ...
  // A permitted live re-read merges by entry_key and re-reads to depth.
  ...
  // "Open entry" honours whether there is anything in-app to open.
  ...
  // Evidence opens for the selected entry and for drift-with-a-change,
