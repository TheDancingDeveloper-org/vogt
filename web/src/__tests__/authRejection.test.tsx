// A credential that stops being valid while the app is running.
//
...
// "signed out" is the forbidden conflation of "offline" with "unauthorized". The
...
describe("#195 — a token refused after boot returns the reader to the login screen", () => {
  ...
  it("keeps the reader signed in when it is the engine that is away", async () => {
    // "offline" and "unauthorized" are different states. A 502 says
