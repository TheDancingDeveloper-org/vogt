// What is on a project page when Vogt answers.
//
...
// every one of its assertions is about an absence. The project page requirement is a claim about a
...
// four tabs `place().view` names. That is still one page in the requirement's sense and
...
describe("a project page carries the brief Vogt answered with", () => {
...
describe("the graph, the inbox and the import form are on the same page", () => {
  ...
  it("carries the import form, which names the repository and nothing else", async () => {
    // No picker, no listing, no suggestion. The field is where a
