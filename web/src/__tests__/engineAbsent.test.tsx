// The absent state's other half: the engine is away, not Vogt.
//
...
// to design an absent state for. The case the requirement names is the other one: the
...
describe("an engine outage does not take the Vogt views with it", () => {
...
describe("the session controls stop, and say the engine's own reason", () => {
  it("disables the start-session form and names why", async () => {
    ...
    // The start form is collapsed. Opening it is what reveals the
