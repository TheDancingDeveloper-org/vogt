...
describe("file workflows", () => {
  ...
  it("refuses to create over an existing file instead of silently overwriting it", async () => {
  ...
  it("moves through and picks a result with the arrow keys and Enter", async () => {
