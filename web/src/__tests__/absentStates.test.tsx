// Designed absent states, on all five Vogt surfaces, as something rendered rather than read.
//
...
// copy is any good. That is in the demo, and the demo needs a browser."
//
...
//      exact failure a designed absent state exists to prevent.
//
...
describe("the projects surface reports the outage", () => {
...
describe("the audit browser reports the outage", () => {
