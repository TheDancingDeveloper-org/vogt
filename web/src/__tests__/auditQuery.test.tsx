// What the audit browser *asks Vogt for*.
//
...
describe("the project filter is a parameter", () => {
...
describe("the time range is two instants on the wire", () => {
...
describe("the browser can read past the newest records", () => {
...
describe("a query Vogt refuses is not an empty log", () => {
...
// -- the link is the query, and stays it across a live re-read ------

describe("a pasted link is the query it names", () => {
...
describe("a live re-read asks the same question again", () => {
