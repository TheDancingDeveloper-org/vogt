// The keyboard path to the Vogt surfaces.
//
...
describe("every read surface by fuzzy name", () => {
...
describe("a mutating verb opens the view that collects its reason", () => {
...
// -- the palette's fourth read surface --------------------------------------
//
...
// not much of one — but until something does, the "sessions" in the palette's
...
describe("sessions are a read surface, and reachable by name", () => {
  afterEach(async () => {
