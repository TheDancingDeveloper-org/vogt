// The liveness requirement, all three of its clauses, on the surfaces that hold them.
//
...
describe("a stale view never presents itself as current", () => {
...
describe("every Vogt surface says how old it is", () => {
  ...
  it("the item page says how old it is, where a stale read is quietest", async () => {
    ...
    // The item page subscribes now, so it reads "Live" rather than
...
describe("the board reloads on what the front door announced", () => {
  ...
  it("does not re-read under a reason somebody is typing", async () => {
    ...
    // Drop a card, which opens the reason composer every write requires. A refetch here
...
// -- clause one: the item page and the backlog -----------------------

describe("the item page reconciles on what the front door announced", () => {
...
describe("the backlog reconciles on tab return but not on every nudge", () => {
...
describe("drift arrivals reach the inbox without being asked for", () => {
  function inbox() {
  ...
  it("does not throw away a reason somebody is part-way through typing", async () => {
    ...
    // The write's reason is the user's sentence, and a background re-read
...
describe("the notification count is re-read, not remembered", () => {
...
describe("a lost stream is indicated and reconciles on reconnect", () => {
...
describe("the backlog says what it is rather than what it is not", () => {
