// The work-item link's return leg: a terminal opened for a work item links back to it.
//
...
// working whatever Vogt is doing, so every failure mode of this badge
...
describe("a terminal says which work item it was opened for", () => {
  ...
  it("keeps the terminal when Vogt cannot be asked at all", async () => {
    // The badge is worth having and worth nothing at all if it costs
    // the terminal.
