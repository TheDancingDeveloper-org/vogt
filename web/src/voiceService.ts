// The phone half of a voice conversation (VOICE_POC §3.6).
//
 ...
 * trusted origin and the main frame, absent everywhere else. It takes a
 ...
 * 30-minute battery + socket-survival measurement — the number itself
 ...
 * text of each arriving push. The *decision to speak* — only
 * while a conversation is active — belongs to the caller: outside an active
 * conversation the push behaves exactly as it already does, shown and
