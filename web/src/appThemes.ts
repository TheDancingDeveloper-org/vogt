 ...
 * whole PWA rather than just the terminal.
 *
 * A theme is a token set defined in `styles.css` under a `[data-theme="…"]`
 * block; this module is the selection/persistence/broadcast layer over it.
 *
...
/** The stored selection (`system` or a theme id). */
