 ...
 *. These cover the pure decision layer: the origin allowlist the
 ...
 * WebView while the trusted PWA still works — is the emulator journey.
 */
public class MainActivityTest {
    ...
    public void clipboard_read_from_a_subframe_is_refused_and_never_touches_the_clipboard() {
        ...
        // No reply, and — this is the point — the clipboard is never even read.
        assertNull(reply);
