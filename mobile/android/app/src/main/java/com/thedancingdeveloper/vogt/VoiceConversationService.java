 ...
 * conversation. It exists to keep the process alive across screen-off —
...
public class VoiceConversationService extends Service {
    ...
    private void startInForeground() {
        ...
        // Measurement hook: the device tester reads conversation
        ...
        try {
            ...
            // just will not survive screen-off (degraded).
    ...
    private Notification buildNotification() {
        ...
        return new NotificationCompat.Builder(this, CHANNEL_ID)
            // Names the app: the persistent notification must name the app.
    ...
    private void acquireWakeLock() {
        ...
        // released in onDestroy. Battery cost of holding it is what an
        // on-device measurement is there to read.
