...
public class MainActivity extends BridgeActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // gui_stream_url — from calling in. WebMessageListener
        ...
        // emulator journey; this change is unit-covered in MainActivityTest.
    ...
    private void publishInsetCssVars(WebView webView, Insets bars) {
        ...
        String script = String.format(
            "(() => {" +
                ...
                "d.nativeInsetLeft='%d';" +
                "window.dispatchEvent(new CustomEvent('vogt:native-insets'));" +
            "})()",
     ...
     * bridges unregistered — fail closed, never open.
     */
     ...
     * so no embedded frame can start or stop the mic service.
     */
    ...
    /**
     * Start/stop the voice foreground service. Held only while a voice
