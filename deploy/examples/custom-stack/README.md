...
This is the whole public extension contract in one place — the exact
shape a private derivative takes. You derive
...
| The voice pair | the release | `voice.image` pinned to the release matching the stack digest |
