"""Branch ↔ work-item binding — the naming convention, stated once.
...
- ``gh-264-…`` — the forge issue number, for a linked project whose items are
  its upstream issues. The number alone is recorded here; resolving it
...
The binding is **observed-first and additive**: matching a branch never
