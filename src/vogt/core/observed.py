...
def upstream_state(
    ...
    """Map mirror lifecycle + overlay refinement onto a workflow state.
    ...
    and drift keeps the pair honest.
    """
...
def is_worklike(observation: Observation) -> bool:
    ...
    Promotion is applied here for markers: an unpromoted marker is
...
def implemented_targets(observation: Observation) -> set[str]:
    """The work-item subject keys a PR observation says it implements.
