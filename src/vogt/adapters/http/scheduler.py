...
Freshness makes the difference *visible*; the schedule is what keeps
it small.
...
#: and "the schedule ran" is the honest answer here — there is no
#: person to name.
SCHEDULED_REASON = "scheduled sweep"
