...
§1.1). Read-only collectors ship here because the estate this tool
...
Write-back, historical backfill and forge-derived drift are separate,
opt-in pieces. Nothing in the collectors mutates anything upstream — they
only ever read.
"""
