"""What GitHub is trying to tell you about a registered project.
...
. `GET /repos/{owner}/{repo}/notifications` can only answer about a
...
signals destroy (ARCHITECTURE.md). They are read through their own view instead.
"""
...
class GitHubNotificationCollector:
    ...
    def collect(self, ctx: CollectorContext, project: Project) -> Iterable[Finding]:
        ...
        # partial coverage and the subject stays "not collected".
    ...
    def _to_findings(
        ...
        for item in payloads:
            ...
            yield finding(
                ...
                # Never promoted. See the module docstring.
                promoted=False,
                payload={
                    "thread": thread,
