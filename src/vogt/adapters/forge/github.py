...
GitHub. The import is function-local on purpose: `ForgeWriter` reaches
...
class GitHubProvider:
    ...
    def notifications(self, ref: RepoRef) -> Iterable[ForgeNotification]:
        ...
        # construction. `all=true` keeps read threads, which are still
    ...
    # -- write surface (delegates to the one mutator) ----------------------
    ...
    def create_repo(
        ...
        which is the whole point of per-actor forge identity. GitHub answers a
