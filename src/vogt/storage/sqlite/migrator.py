"""Forward-only migrations, under a lock.
...
3. **Gated.** Readiness waits on this completing (`DEPLOYMENT.md`).
"""
...
class Migrator:
    ...
    def bundled_version(self) -> int:
        ...
        expects. Readiness is the gap between them, and for a long time
        nothing compared the two: readiness reported the applied number on its own,
