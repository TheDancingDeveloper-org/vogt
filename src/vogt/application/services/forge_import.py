...
under the same credential the listing used, registers it, and runs a
...
def import_forge_repo(
    ...
    """Clone + register + consolidate a repository the picker listed."""
    ...
    # The same credential resolution the picker uses: the acting actor's
