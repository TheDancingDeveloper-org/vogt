"""Bounded, snapshot-stable Board projection."""
...
def list_board(ctx: AppContext, params: BoardListParams) -> BoardListResult:
    ...
    with ctx.declared.read() as view:
        ...
        if project_row is not None and not upstream.is_linked(project_row):
            # The unlinked CTA answer: an unlinked project has no Board. Empty
        ...
        # The upstream-truth half of the Board: linked projects'
    ...
    # The honest denominator: how many things the Backlog would consider
...
def _unlinked_board(
    ...
    """Empty cells plus the link-or-publish marker.
...
def _work_filter(
    ...
    return WorkFilter(
        ...
        # The forge-less withdrawal: unlinked projects' native rows are not Board
