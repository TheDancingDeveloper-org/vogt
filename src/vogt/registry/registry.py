...
Parity exclusions are **explicit named lists** that fail when stale in
...
#: Operations that exist only where the data directory is (ARCHITECTURE.md).
...
class OperationRegistry:
    ...
    def _validate_reasons(self) -> None:
        ...
        `reason` is part of every audit row, and ARCHITECTURE.md makes
