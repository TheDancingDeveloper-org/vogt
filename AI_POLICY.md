...
- **You must hold the rights to what you submit.** Contributions are
  accepted under the repository's AGPL-3.0-only licence, with a Developer
  Certificate of Origin sign-off; submitting output you are not entitled to
  license is your responsibility, not the project's.
